    ...
    return (
        <section id="contact" className="section-padding relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,100vw)] h-[min(600px,80vh)] bg-accent/10 rounded-full blur-[100px] sm:blur-[120px]" />
                <div className="absolute bottom-0 right-0 w-48 h-48 sm:w-[400px] sm:h-[400px] bg-purple-500/5 rounded-full blur-[80px] sm:blur-[100px]" />
            </div>

            <div className="max-w-5xl mx-auto container-padding relative z-10">
                <div className="bg-secondary/40 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-16 text-center">
                    <motion.div
                    ...
                    >
                        <a
                            ...
                            className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-10 py-4 sm:py-6 bg-accent text-white rounded-xl sm:rounded-2xl font-bold text-base sm:text-xl hover:bg-blue-600 transition-all hover:shadow-[0_0_40px_rgba(37,99,235,0.4)] hover:-translate-y-1 w-full sm:w-auto max-w-md"
                        >
                        ...
                        <div className="flex flex-col items-center gap-3 sm:gap-4 w-full">
                            ...
                            <button
                                ...
                                className="text-[10px] uppercase tracking-widest text-text-secondary hover:text-white transition-colors bg-white/5 px-4 py-2 rounded-full border border-white/5 hover:border-white/10 min-h-11"
                            >
                                Click to copy email
                            </button>
                        </div>
